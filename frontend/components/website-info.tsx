  ...
  return (
    <div className="space-y-6 p-4 sm:p-6 md:p-8">
      <div className="text-center mb-8">
        <h1 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">Monastery360</h1>
        ...
        {features.map((feature, index) => (
          <Card key={index} className="p-6 border border-border">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-foreground mb-2 sm:mb-1">{feature.title}</h3>
